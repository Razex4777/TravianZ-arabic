				...
				<tr>
					...
					<td width="20%">
						<select name="new_functions_oasis">
							<option value="True" <?php if(NEW_FUNCTIONS_OASIS == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_OASIS == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_alliance_invitation">
							<option value="True" <?php if(NEW_FUNCTIONS_ALLIANCE_INVITATION == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_ALLIANCE_INVITATION == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_embassy_mechanics">
							<option value="True" <?php if(NEW_FUNCTIONS_EMBASSY_MECHANICS == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_EMBASSY_MECHANICS == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_forum_post_message">
							<option value="True" <?php if(NEW_FUNCTIONS_FORUM_POST_MESSAGE == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_FORUM_POST_MESSAGE == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_tribe_images">
							<option value="True" <?php if(NEW_FUNCTIONS_TRIBE_IMAGES == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_TRIBE_IMAGES == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_mhs_images">
							<option value="True" <?php if(NEW_FUNCTIONS_MHS_IMAGES == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_MHS_IMAGES == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_display_artifact">
							<option value="True" <?php if(NEW_FUNCTIONS_DISPLAY_ARTIFACT == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_DISPLAY_ARTIFACT == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_display_wonder">
							<option value="True" <?php if(NEW_FUNCTIONS_DISPLAY_WONDER == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_DISPLAY_WONDER == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_vacation">
							<option value="True" <?php if(NEW_FUNCTIONS_VACATION == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_VACATION == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_display_catapult_target">
							<option value="True" <?php if(NEW_FUNCTIONS_DISPLAY_CATAPULT_TARGET == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_DISPLAY_CATAPULT_TARGET == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_manual_naturenatars">
							<option value="True" <?php if(NEW_FUNCTIONS_MANUAL_NATURENATARS == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_MANUAL_NATURENATARS == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_display_links">
							<option value="True" <?php if(NEW_FUNCTIONS_DISPLAY_LINKS == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_DISPLAY_LINKS == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_medal_3year">
							<option value="True" <?php if(NEW_FUNCTIONS_MEDAL_3YEAR == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_MEDAL_3YEAR == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_medal_5year">
							<option value="True" <?php if(NEW_FUNCTIONS_MEDAL_5YEAR == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_MEDAL_5YEAR == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="new_functions_medal_10year">
							<option value="True" <?php if(NEW_FUNCTIONS_MEDAL_10YEAR == true) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'صحيح' : 'True'; ?></option>
							<option value="False" <?php if(NEW_FUNCTIONS_MEDAL_10YEAR == false) echo "selected";?>><?php echo (defined('LANG') && LANG === 'ar') ? 'خطأ' : 'False'; ?></option>
						</select>
					</td>
				</tr>
			</tbody>
