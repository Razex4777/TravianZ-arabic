...
<form method="post" action="allianz.php">
	<table cellpadding="1" cellspacing="1" id="position" class="small_option">
		...
		<tbody>
			...
			<tr>
				<th><?php echo (defined('LANG') && LANG === 'ar') ? 'المنصب:' : 'Position:'; ?></th>
  ...
  <table cellpadding="1" cellspacing="1" id="rights" class="small_option">
						...
						<thead>
							<tr>
								<th colspan="2"><?php echo (defined('LANG') && LANG === 'ar') ? 'تعيين الصلاحيات' : 'Assign rights'; ?></th>
						  </tr>
						</thead>
						<tbody>
							<tr>
					...
					<p>
					  ...
					  <input type="hidden" name="a_user" value="<?php echo (isset($_POST['a_user']) ? $_POST['a_user'] : ''); ?>">
						<input type="image" value="ok" name="s1" id="btn_ok" class="dynamic_img" src="img/x.gif" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'موافق' : 'OK'; ?>" />
  </p>
				</form>
