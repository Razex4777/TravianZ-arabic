...
<tr>
<th colspan="2"><?php echo (defined('LANG') && LANG === 'ar') ? 'تغيير الاسم' : 'Change name'; ?></th>
</tr></thead>
<tbody><tr>
...
<p><button value="ok" name="s1" id="btn_ok" class="trav_buttons" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'موافق' : 'OK'; ?>" /> <?php echo (defined('LANG') && LANG === 'ar') ? 'موافق' : 'Ok'; ?> </button></form></p>
