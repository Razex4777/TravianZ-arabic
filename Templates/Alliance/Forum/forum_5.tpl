...
<form method="post" name="post" action="allianz.php?s=2&fid=<?php echo $_GET['fid']; ?>">
	...
	<tr>
        <th colspan="3"><?php echo (defined('LANG') && LANG === 'ar') ? 'إنشاء موضوع جديد' : 'Post new thread'; ?></th>
	</tr>
	</thead>
	...
	<tr>
		...
		<th><?php echo (defined('LANG') && LANG === 'ar') ? 'الموضوع' : 'Thread'; ?></td>
	...
	<td colspan="2">
			...
			<div bbArea="text" id="text_container" name="text_container">
				...
				<div id="text_toolbar" name="text_toolbar">
					<a href="javascript:void(0);" bbType="d" bbTag="b" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'عريض' : 'bold'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'عريض' : 'bold'; ?>" class="bbButton bbBold"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="i" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'مائل' : 'italic'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'مائل' : 'italic'; ?>" class="bbButton bbItalic"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="u" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'تحته خط' : 'underlined'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'تحته خط' : 'underlined'; ?>" class="bbButton bbUnderscore"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="alliance" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'تحالف' : 'Alliance'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'تحالف' : 'Alliance'; ?>" class="bbButton bbAlliance"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="player" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'لاعب' : 'Player'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'لاعب' : 'Player'; ?>" class="bbButton bbPlayer"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="coor" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'إحداثيات' : 'Coordinates'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'إحداثيات' : 'Coordinates'; ?>" class="bbButton bbCoordinate"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="report" ><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'تقرير' : 'Report'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'تقرير' : 'Report'; ?>" class="bbButton bbReport"></div></a>
					<a href="javascript:void(0);" bbWin="resources" id="text_resourceButton"><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'الموارد' : 'Resources'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'الموارد' : 'Resources'; ?>" class="bbButton bbResource"></div></a>

					<a href="javascript:void(0);" bbWin="smilies" id="text_smilieButton"><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'وجوه' : 'Smilies'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'وجوه' : 'Smilies'; ?>" class="bbButton bbSmilie"></div></a>
					<a href="javascript:void(0);" bbWin="troops" id="text_troopButton"><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'القوات' : 'Troops'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'القوات' : 'Troops'; ?>" class="bbButton bbTroop"></div></a>
					<a href="javascript:void(0);" id="text_previewButton" bbArea="text"><div title="<?php echo (defined('LANG') && LANG === 'ar') ? 'معاينة' : 'Preview'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'معاينة' : 'Preview'; ?>" class="bbButton bbPreview"></div></a>
					<div class="clear"></div>
					<div id="text_toolbarWindows">
						<div id="text_resources" name="text_resources">
								<a href="javascript:void(0);" bbType="o" bbTag="lumber" ><img src="img/x.gif" class="r1" title="<?php echo (defined('LANG') && LANG === 'ar') ? 'خشب' : 'Wood'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'خشب' : 'Wood'; ?>" /></a>
								<a href="javascript:void(0);" bbType="o" bbTag="clay" ><img src="img/x.gif" class="r2" title="<?php echo (defined('LANG') && LANG === 'ar') ? 'طين' : 'Clay'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'طين' : 'Clay'; ?>" /></a>
								<a href="javascript:void(0);" bbType="o" bbTag="iron" ><img src="img/x.gif" class="r3" title="<?php echo (defined('LANG') && LANG === 'ar') ? 'حديد' : 'Iron'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'حديد' : 'Iron'; ?>" /></a>
							<a href="javascript:void(0);" bbType="o" bbTag="crop" ><img src="img/x.gif" class="r4" title="<?php echo (defined('LANG') && LANG === 'ar') ? 'قمح' : 'Crop'; ?>" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'قمح' : 'Crop'; ?>" /></a></div>
		...
		<th><?php echo (defined('LANG') && LANG === 'ar') ? 'استطلاع' : 'survey'; ?></th>
		<td>
	...
	<tr id="options" class="hide">
		...
		<td>
<?php $optLabel = (defined('LANG') && LANG === 'ar') ? 'الخيار' : 'Option'; ?>
<?php echo $optLabel; ?> 1: <input class="text" type="text" name="option_1" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 2: <input class="text" type="text" name="option_2" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 3: <input class="text" type="text" name="option_3" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 4: <input class="text" type="text" name="option_4" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 5: <input class="text" type="text" name="option_5" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 6: <input class="text" type="text" name="option_6" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 7: <input class="text" type="text" name="option_7" maxlength="100" style="width:150px"/><br>
<?php echo $optLabel; ?> 8: <input class="text" type="text" name="option_8" maxlength="100" style="width:150px"/><br>
</td>
<td></td>
		</tr>
<tr>
	<th><?php echo (defined('LANG') && LANG === 'ar') ? 'ينتهي في' : 'ends on'; ?></th>
	<td>
...
//-->
</script><select class="dropdown" name="month" disabled="disabled"><option value="01"><?php echo (defined('LANG') && LANG === 'ar') ? 'يناير' : 'Jan'; ?></option><option value="02"><?php echo (defined('LANG') && LANG === 'ar') ? 'فبراير' : 'Feb'; ?></option><option value="03"><?php echo (defined('LANG') && LANG === 'ar') ? 'مارس' : 'Mar'; ?></option><option value="04"><?php echo (defined('LANG') && LANG === 'ar') ? 'أبريل' : 'Apr'; ?></option><option value="05"><?php echo (defined('LANG') && LANG === 'ar') ? 'مايو' : 'May'; ?></option><option value="06"><?php echo (defined('LANG') && LANG === 'ar') ? 'يونيو' : 'Jun'; ?></option><option value="07"><?php echo (defined('LANG') && LANG === 'ar') ? 'يوليو' : 'Jul'; ?></option><option value="08"><?php echo (defined('LANG') && LANG === 'ar') ? 'أغسطس' : 'Aug'; ?></option><option value="09" selected="selected"><?php echo (defined('LANG') && LANG === 'ar') ? 'سبتمبر' : 'Sep'; ?></option><option value="10"><?php echo (defined('LANG') && LANG === 'ar') ? 'أكتوبر' : 'Oct'; ?></option><option value="11"><?php echo (defined('LANG') && LANG === 'ar') ? 'نوفمبر' : 'Nov'; ?></option><option value="12"><?php echo (defined('LANG') && LANG === 'ar') ? 'ديسمبر' : 'Dec'; ?></option></select><select class="dropdown" name="day" disabled="disabled"><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19" selected="selected">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select><select class="dropdown" name="year" disabled="disabled"><option value="<?php echo date('Y'); ?>" selected="selected"><?php echo date('y'); ?></option><option value="<?php echo date('Y')+1; ?>"><?php echo date('y')+1; ?></option></select>&nbsp;&nbsp;&nbsp;<select class="dropdown" name="hour" disabled="disabled"><option value="00">00</option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10" selected="selected">10</option><option value="11">11</option></select><select class="dropdown" name="minute" disabled="disabled"><option value="0">00</option><option value="1">01</option><option value="2">02</option><option value="3">03</option><option value="4" selected="selected">04</option><option value="5">05</option><option value="6">06</option><option value="7">07</option><option value="8">08</option><option value="9">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option></select>

		   <input class="radio" type="radio" name="meridiem" value="0" disabled="disabled" /><?php echo (defined('LANG') && LANG === 'ar') ? 'ص' : 'am'; ?>
		   <input class="radio" type="radio" name="meridiem" value="1" disabled="disabled" checked="checked" /><?php echo (defined('LANG') && LANG === 'ar') ? 'م' : 'pm'; ?></td><td class="sel"><input class="check" type="checkbox" name="umfrage_ende" onclick="voteEnd();" />
	</td>
</tr></tbody></table>


<p class="btn"><input type="image" id="fbtn_ok" value="ok" name="s1" class="dynamic_img" src="img/x.gif" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'موافق' : 'OK'; ?>" /></form></p>
