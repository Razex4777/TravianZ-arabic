<div id="raidListCreate">
	<h4><?php echo (defined('LANG') && LANG === 'ar') ? 'إنشاء قائمة جديدة' : 'Create a new list'; ?></h4>
	<form action="build.php?gid=16&t=99" method="post">
        ...
        <input type="hidden" name="action" value="addList">
			<table cellpadding="1" cellspacing="1" class="transparent" id="raidList">
				<tbody><tr>
					<th>
						<?php echo (defined('LANG') && LANG === 'ar') ? 'الاسم:' : 'Name:'; ?>					</th>
					<td>
				...
				<tr>
					<th>
						<?php echo (defined('LANG') && LANG === 'ar') ? 'القرية:' : 'Village:'; ?>					</th>
					<td>
...
<button class="trav_buttons" type="submit" value="create"><?php echo (defined('LANG') && LANG === 'ar') ? 'إنشاء' : 'Create'; ?></button>
</form>
</div>
