...
$i = 20;
               echo "<tr><td class=\"desc\">
					<div class=\"tit\">
						...
						<a href=\"#\" onClick=\"return Popup(".$i.",1);\">".$technology->getUnitName($i)."</a>  <span class=\"info\">(Available: ".number_format($village->unitarray['u'.$i]).")</span>
					</div>
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        echo "<tr><td class=\"desc\">";
        echo "<img class=\"unit u".$train['unit']."\" src=\"img/x.gif\" alt=\"".$train['name']."\" title=\"".$train['name']."\" />".$train['amt']." ".$train['name']."</td><td class=\"dur\"><span id=timer".++$session->timer.">".$generator->getTimeFormat(($train['commence']+($train['eachtime']*$train['amt']))-time())."</span></td>
		</tr>";
        }
        echo "</tbody></table>";
    }
