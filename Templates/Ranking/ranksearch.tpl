...
<table cellpadding="1" cellspacing="1" id="search_navi">
					<tr>						
						<td>
							...
							<div class="search">											
								<span><?php echo (defined('LANG') && LANG === 'ar') ? 'الترتيب' : 'rank'; ?><input type="text" class="text ra" maxlength="5" name="rank" value="<?php echo ($search == 0)? $start : $search; ?>" /></span>
...
if(count($rankArray) < 22){
    echo "&laquo; ".((defined('LANG') && LANG === 'ar') ? 'السابق' : 'back')." | ".((defined('LANG') && LANG === 'ar') ? 'التالي' : 'forward')." &raquo;";
}else if($start != 1 && $start + 20 < count($rankArray)) {
    echo "<a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start - 20)."\">&laquo; ".((defined('LANG') && LANG === 'ar') ? 'السابق' : 'back')."</a> | <a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start + 20)."\">".((defined('LANG') && LANG === 'ar') ? 'التالي' : 'forward')." &raquo;</a>";
}else if($start == 1 && $start + 20 < count($rankArray)) {
    echo "&laquo; ".((defined('LANG') && LANG === 'ar') ? 'السابق' : 'back')." | <a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start + 20)."\">".((defined('LANG') && LANG === 'ar') ? 'التالي' : 'forward')." &raquo;</a>";
}else if($start != 1 && $start - 20 < count($rankArray)) {
