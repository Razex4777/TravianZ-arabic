...
<form method="POST" name="snd" action="a2b.php"><input name="timestamp" value="1278280730" type="hidden"> <input name="timestamp_checksum" value="597fa8" type="hidden"> <input name="b" value="1" type="hidden">
	...
	<tr>
        ...
        ?>
		<td class="column-last small"><img class="unit u20" src="img/x.gif" title="<?php echo U20; ?>" alt="<?php echo U20; ?>"> <input class="text" <?php if ($village->unitarray['u20']<=0) {echo ' disabled="disabled"';}?> name="t10" value="" maxlength="6" type="text">
		<?php 
