...
<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
	...
	<tbody>
		<tr>
			<td class="pic">
                <img src="img/bezahlung/paypal.jpg" style="99px; height:99px;" alt="Package H" />
    
                <div>
                    Gold : <?php echo (defined('PLUS_PACKAGE_H_GOLD') ? PLUS_PACKAGE_H_GOLD : 20000); ?>
                    <br />
                    Cost : <?php echo (defined('PLUS_PACKAGE_H_PRICE') ? PLUS_PACKAGE_H_PRICE : '299,99') . ' ' . (defined('PAYPAL_CURRENCY') ? PAYPAL_CURRENCY : 'EUR'); ?>
                    <br />
                    Wait: 24 hours
                </div>
                </td>
                <td class="desc">
                    ...
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                      ...
                      <input type="hidden" name="item_name" value="<?php echo SERVER_NAME . ' Package H Gold Pack (' . $session->username . ')'; ?>">
                      <input type="hidden" name="amount" value="<?php echo (defined('PLUS_PACKAGE_H_PRICE') ? str_replace(",", ".", PLUS_PACKAGE_H_PRICE) : '299.99'); ?>">
