<h1><img class="unit u44" src="img/x.gif" alt="Birds Of Prey" title="Birds Of Prey" /> Birds Of Prey <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الناتار" : "Natars"; ?>)</span></h1>
...
<tbody><tr>
	...
	<td><b>25</b> <?php echo (defined("LANG") && LANG === "ar") ? "حقول/ساعة" : "fields/hour"; ?></td>
</tr>
<tr>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=43" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=45" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
