<h1><img class="unit u50" src="img/x.gif" alt="Natarian Settler" title="Natarian Settler" /> Natarian Settler <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الناتار" : "Natars"; ?>)</span></h1>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=49" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?s=5&amp;typ=2" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
