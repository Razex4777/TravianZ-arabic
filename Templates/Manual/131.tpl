<h1><img class="unit u31" src="img/x.gif" alt="<?php echo U31; ?>" title="<?php echo U31; ?>" /> <?php echo U31; ?> <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الطبيعة" : "Nature"; ?>)</span></h1>
...
<tr>
	...
	<td><b>45</b> <?php echo (defined("LANG") && LANG === "ar") ? "موارد" : "resources"; ?></td>
</tr>
<tr>
...
<div id="prereqs"><b><?php echo (defined("LANG") && LANG === "ar") ? "المتطلبات" : "Prerequisites"; ?></b><br /><a href="manual.php?typ=4&amp;gid=26">Baracks</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 1 </div>
<map id="nav" name="nav">
