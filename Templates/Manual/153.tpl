<h1><img class="unit u33" src="img/x.gif" alt="Snake" title="Snake" /> Snake <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الطبيعة" : "Nature"; ?>)</span></h1>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=52" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=54" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
