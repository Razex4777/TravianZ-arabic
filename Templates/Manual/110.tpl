<h1><img class="unit u10" src="img/x.gif" alt="Settler" title="Settler" /> Settler <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الرومان" : "Romans"; ?>)</span></h1>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=9" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
