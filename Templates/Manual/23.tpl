<h1><img class="unit uunits" src="img/x.gif" alt="" title="" /> <?php echo (defined('LANG') && LANG === 'ar') ? 'القوات (الغال)' : 'Troops (<?php echo (defined("LANG") && LANG === "ar") ? "الغال" : "Gauls"; ?>)'; ?></h1>
<ul>
...
<map id="nav" name="nav">
    ...
    <area href="<?php echo NEW_FUNCTIONS_MANUAL_NATURENATARS ? "manual.php?typ=2&amp;s=4" : "manual.php?typ=3&amp;s=1"; ?>" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
