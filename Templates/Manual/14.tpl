<h1><img class="unit u4" src="img/x.gif" alt="Equites Legati" title="Equites Legati" /> Equites Legati <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الرومان" : "Romans"; ?>)</span></h1>
...
<tbody><tr>
	...
	<td><b>16</b> <?php echo (defined("LANG") && LANG === "ar") ? "حقول/ساعة" : "fields/hour"; ?></td>
</tr>
<tr>
...
<img id="big_unit" class="big_u4" src="img/x.gif" alt="Equites Legati" title="Equites Legati" /><div id="t_desc">The Equites Legati are the roman reconnaissance troops. They are pretty fast and can spy on enemy villages in order to see <?php echo (defined("LANG") && LANG === "ar") ? "موارد" : "resources"; ?> and troops.
<br /><br />
If there are no Scouts, Equites Legati or Pathfinders in the scouted village, the scouting remains unnoticed.</div>
<div id="prereqs"><b><?php echo (defined("LANG") && LANG === "ar") ? "المتطلبات" : "Prerequisites"; ?></b><br /><a href="manual.php?typ=4&amp;gid=20">Stable</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 1, <a href="manual.php?typ=4&amp;gid=22">Academy</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 5</div>
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=3" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=5" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
