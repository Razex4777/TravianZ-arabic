<h1><img class="unit u23" src="img/x.gif" alt="Pathfinder" title="Pathfinder" /> Pathfinder <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الغال" : "Gauls"; ?>)</span></h1>
...
<tbody><tr>
	...
	<td><b>17</b> <?php echo (defined("LANG") && LANG === "ar") ? "حقول/ساعة" : "fields/hour"; ?></td>
</tr>
<tr>
...
<img id="big_unit" class="big_u23" src="img/x.gif" alt="Pathfinder" title="Pathfinder" /><div id="t_desc">The Pathfinder is the Gaul's reconnaissance unit. They are very fast and they can carefully advance on the enemy units, <?php echo (defined("LANG") && LANG === "ar") ? "موارد" : "resources"; ?> or buildings to spy on them.
<br /><br />
If there aren't any Scouts, Equites Legati or Pathfinders in the scouted village, the scouting remains unnoticed.</div>
<div id="prereqs"><b><?php echo (defined("LANG") && LANG === "ar") ? "المتطلبات" : "Prerequisites"; ?></b><br /><a href="manual.php?typ=4&amp;gid=22">Academy</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 5, <a href="manual.php?typ=4&amp;gid=20">Stable</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 1</div>
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=22" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=24" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
