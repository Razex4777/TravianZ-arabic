<h1><img class="unit u11" src="img/x.gif" alt="Clubswinger" title="Clubswinger" /> Clubswinger <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "التيوتون" : "Teutons"; ?>)</span></h1>
...
<tr>
	...
	<td><b>60</b> <?php echo (defined("LANG") && LANG === "ar") ? "موارد" : "resources"; ?></td>
</tr>
<tr>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=2&amp;s=2" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=12" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
