<h1><img class="unit u20" src="img/x.gif" alt="Settler" title="Settler" /> Settler <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "التيوتون" : "Teutons"; ?>)</span></h1>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=19" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
