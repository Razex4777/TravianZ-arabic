<h1><img class="unit u21" src="img/x.gif" alt="Phalanx" title="Phalanx" /> Phalanx <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الغال" : "Gauls"; ?>)</span></h1>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=22" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
