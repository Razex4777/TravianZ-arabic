...
<p><?php echo (defined('LANG') && LANG === 'ar') ? 'توفر لك المساعدة داخل اللعبة إمكانية البحث عن المعلومات المهمة في أي وقت.' : 'This ingame help offers you the chance to look up important information at any time.'; ?></p>
<img class="troops" src="img/x.gif" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'القوات' : 'Troops'; ?>" title="<?php echo (defined('LANG') && LANG === 'ar') ? 'القوات' : 'Troops'; ?>" />
<img class="buildings" src="img/x.gif" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'المباني' : 'Buildings'; ?>" title="<?php echo (defined('LANG') && LANG === 'ar') ? 'المباني' : 'Buildings'; ?>" />
<ul>
