<h1><img class="unit u29" src="img/x.gif" alt="Chieftain" title="Chieftain" /> Chieftain <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الغال" : "Gauls"; ?>)</span></h1>
...
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=28" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=30" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
