<h1><img class="unit u30" src="img/x.gif" alt="Settler" title="Settler" /> Settler <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الغال" : "Gauls"; ?>)</span></h1>
...
<tr>
	...
	<td><b>3000</b> <?php echo (defined("LANG") && LANG === "ar") ? "موارد" : "resources"; ?></td>
</tr>
<tr>
...
<div id="prereqs"><b><?php echo (defined("LANG") && LANG === "ar") ? "المتطلبات" : "Prerequisites"; ?></b><br /><a href="manual.php?typ=4&amp;gid=26">Palace</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 10 or <a href="manual.php?typ=4&amp;gid=25">Residence</a> <?php echo (defined("LANG") && LANG === "ar") ? "المستوى" : "Level"; ?> 10</div>
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=29" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?s=3&amp;typ=2" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
