<h1><img class="unit u45" src="img/x.gif" alt="Axerider" title="Axerider" /> Axerider <span class="tribe">(<?php echo (defined("LANG") && LANG === "ar") ? "الناتار" : "Natars"; ?>)</span></h1>
...
<tbody><tr>
	...
	<td><b>14</b> <?php echo (defined("LANG") && LANG === "ar") ? "حقول/ساعة" : "fields/hour"; ?></td>
</tr>
<tr>
...
<div id="prereqs"><p><b><?php echo (defined("LANG") && LANG === "ar") ? "المتطلبات" : "Prerequisites"; ?></b><br>Description is intended for reference only. The <?php echo (defined("LANG") && LANG === "ar") ? "الناتار" : "Natars"; ?> are a pure NPC tribe and thus cannot be played by oneself.</p></div>
<map id="nav" name="nav">
    <area href="manual.php?typ=1&amp;s=34" title="<?php echo (defined("LANG") && LANG === "ar") ? 'رجوع' : 'back'; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo (defined("LANG") && LANG === "ar") ? 'نظرة عامة' : 'Overview'; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=46" title="<?php echo (defined("LANG") && LANG === "ar") ? 'التالي' : 'forward'; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
